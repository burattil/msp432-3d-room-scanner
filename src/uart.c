...
void UART_Init(void) {
  ...
  UART0_CC_R = (UART0_CC_R&~UART_CC_CS_M)+UART_CC_CS_PIOSC;  // UART gets its clock from the alternate clock source as defined by SYSCTL_ALTCLKCFG_R
                                        
  SYSCTL_ALTCLKCFG_R = (SYSCTL_ALTCLKCFG_R&~SYSCTL_ALTCLKCFG_ALTCLK_M)+SYSCTL_ALTCLKCFG_ALTCLK_PIOSC;  // the alternate clock source is the PIOSC (default)
