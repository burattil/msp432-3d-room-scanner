...
This parameter can be modified in `ToFSensor.h` and `visualization/3d_room_scanner.py`. The parameter must be changed in both files for proper functionality.
...
<p align="center">
    <img width="972" height="377" alt="image" src="https://github.com/user-attachments/assets/5f3546eb-ccce-42dc-b945-af78c0673014">
</p>
